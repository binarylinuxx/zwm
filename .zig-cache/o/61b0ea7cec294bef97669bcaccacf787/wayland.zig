...
pub const client = struct {
    ...
    pub const zxdg = struct {
        ...
        pub const OutputManagerV1 = opaque {
            pub const generated_version = 3;
            pub const interface = &common.zxdg.output_manager_v1.interface;
            pub fn getId(_output_manager_v1: *OutputManagerV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_output_manager_v1)).getId();
            }
            pub fn getVersion(_output_manager_v1: *OutputManagerV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_output_manager_v1)).getVersion();
            }
            pub fn getUserData(_output_manager_v1: *OutputManagerV1) ?*anyopaque {
                return @as(*client.wl.Proxy, @ptrCast(_output_manager_v1)).getUserData();
            }
            pub fn setQueue(_output_manager_v1: *OutputManagerV1, _queue: *client.wl.EventQueue) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_output_manager_v1);
                _proxy.setQueue(_queue);
            }
            pub fn destroy(_output_manager_v1: *OutputManagerV1) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_output_manager_v1);
                _proxy.marshal(0, null);
                _proxy.destroy();
            }
            pub fn getXdgOutput(_output_manager_v1: *OutputManagerV1, _output: *client.wl.Output) !*client.zxdg.OutputV1 {
                const _proxy: *client.wl.Proxy = @ptrCast(_output_manager_v1);
                var _args = [_]common.Argument{
                    .{ .o = null },
                    .{ .o = @ptrCast(_output) },
                };
                return @ptrCast(try _proxy.marshalConstructor(1, &_args, client.zxdg.OutputV1.interface));
            }
        };
        pub const OutputV1 = opaque {
            pub const generated_version = 3;
            pub const interface = &common.zxdg.output_v1.interface;
            pub fn getId(_output_v1: *OutputV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_output_v1)).getId();
            }
            pub fn getVersion(_output_v1: *OutputV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_output_v1)).getVersion();
            }
            pub fn getUserData(_output_v1: *OutputV1) ?*anyopaque {
                return @as(*client.wl.Proxy, @ptrCast(_output_v1)).getUserData();
            }
            pub fn setQueue(_output_v1: *OutputV1, _queue: *client.wl.EventQueue) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_output_v1);
                _proxy.setQueue(_queue);
            }
            pub const Event = union(enum) {
                logical_position: struct {
                    x: i32,
                    y: i32,
                },
                logical_size: struct {
    ...
    pub const zwlr = struct {
        pub const LayerShellV1 = opaque {
            ...
            pub fn getLayerSurface(_layer_shell_v1: *LayerShellV1, _surface: *client.wl.Surface, _output: ?*client.wl.Output, _layer: Layer, _namespace: [*:0]const u8) !*client.zwlr.LayerSurfaceV1 {
                const _proxy: *client.wl.Proxy = @ptrCast(_layer_shell_v1);
                var _args = [_]common.Argument{
                    .{ .o = null }, .{ .o = @ptrCast(_surface) }, .{ .o = @ptrCast(_output) },
        ...
        pub const ScreencopyManagerV1 = opaque {
            pub const generated_version = 3;
            pub const interface = &common.zwlr.screencopy_manager_v1.interface;
            pub fn getId(_screencopy_manager_v1: *ScreencopyManagerV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_screencopy_manager_v1)).getId();
            }
            pub fn getVersion(_screencopy_manager_v1: *ScreencopyManagerV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_screencopy_manager_v1)).getVersion();
            }
            pub fn getUserData(_screencopy_manager_v1: *ScreencopyManagerV1) ?*anyopaque {
                return @as(*client.wl.Proxy, @ptrCast(_screencopy_manager_v1)).getUserData();
            }
            pub fn setQueue(_screencopy_manager_v1: *ScreencopyManagerV1, _queue: *client.wl.EventQueue) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_screencopy_manager_v1);
                _proxy.setQueue(_queue);
            }
            pub fn captureOutput(_screencopy_manager_v1: *ScreencopyManagerV1, _overlay_cursor: i32, _output: *client.wl.Output) !*client.zwlr.ScreencopyFrameV1 {
                const _proxy: *client.wl.Proxy = @ptrCast(_screencopy_manager_v1);
                var _args = [_]common.Argument{
                    .{ .o = null },
                    .{ .i = _overlay_cursor },
                ...
                return @ptrCast(try _proxy.marshalConstructor(0, &_args, client.zwlr.ScreencopyFrameV1.interface));
            }
            pub fn captureOutputRegion(_screencopy_manager_v1: *ScreencopyManagerV1, _overlay_cursor: i32, _output: *client.wl.Output, _x: i32, _y: i32, _width: i32, _height: i32) !*client.zwlr.ScreencopyFrameV1 {
                const _proxy: *client.wl.Proxy = @ptrCast(_screencopy_manager_v1);
                var _args = [_]common.Argument{
                    .{ .o = null },
                    .{ .i = _overlay_cursor },
                ...
                return @ptrCast(try _proxy.marshalConstructor(1, &_args, client.zwlr.ScreencopyFrameV1.interface));
            }
            pub fn destroy(_screencopy_manager_v1: *ScreencopyManagerV1) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_screencopy_manager_v1);
                _proxy.marshal(2, null);
                _proxy.destroy();
            }
        };
        pub const ScreencopyFrameV1 = opaque {
            pub const generated_version = 3;
            pub const interface = &common.zwlr.screencopy_frame_v1.interface;
            pub const Error = common.zwlr.screencopy_frame_v1.Error;
            pub const Flags = common.zwlr.screencopy_frame_v1.Flags;
            pub fn getId(_screencopy_frame_v1: *ScreencopyFrameV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_screencopy_frame_v1)).getId();
            }
            pub fn getVersion(_screencopy_frame_v1: *ScreencopyFrameV1) u32 {
                return @as(*client.wl.Proxy, @ptrCast(_screencopy_frame_v1)).getVersion();
            }
            pub fn getUserData(_screencopy_frame_v1: *ScreencopyFrameV1) ?*anyopaque {
                return @as(*client.wl.Proxy, @ptrCast(_screencopy_frame_v1)).getUserData();
            }
            pub fn setQueue(_screencopy_frame_v1: *ScreencopyFrameV1, _queue: *client.wl.EventQueue) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_screencopy_frame_v1);
                _proxy.setQueue(_queue);
            }
            pub const Event = union(enum) {
                buffer: struct {
            ...
            pub inline fn setListener(
                _screencopy_frame_v1: *ScreencopyFrameV1,
                comptime T: type,
                _listener: *const fn (screencopy_frame_v1: *ScreencopyFrameV1, event: Event, data: T) void,
                _data: T,
            ) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_screencopy_frame_v1);
                const _mut_data: ?*anyopaque = @ptrFromInt(@intFromPtr(_data));
                _proxy.addDispatcher(common.Dispatcher(ScreencopyFrameV1, T).dispatcher, _listener, _mut_data);
            }
            pub fn copy(_screencopy_frame_v1: *ScreencopyFrameV1, _buffer: *client.wl.Buffer) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_screencopy_frame_v1);
                var _args = [_]common.Argument{
                    .{ .o = @ptrCast(_buffer) },
                };
            ...
            pub fn destroy(_screencopy_frame_v1: *ScreencopyFrameV1) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_screencopy_frame_v1);
                _proxy.marshal(1, null);
                _proxy.destroy();
            }
            pub fn copyWithDamage(_screencopy_frame_v1: *ScreencopyFrameV1, _buffer: *client.wl.Buffer) void {
                const _proxy: *client.wl.Proxy = @ptrCast(_screencopy_frame_v1);
                var _args = [_]common.Argument{
                    .{ .o = @ptrCast(_buffer) },
                };
...
pub const server = struct {
    ...
    pub const zxdg = struct {
        ...
        pub const OutputManagerV1 = opaque {
            pub const generated_version = 3;
            pub const interface = &common.zxdg.output_manager_v1.interface;
            pub fn create(_client: *server.wl.Client, _version: u32, _id: u32) !*OutputManagerV1 {
                return @ptrCast(try server.wl.Resource.create(_client, OutputManagerV1, _version, _id));
            }
            pub fn destroy(_output_manager_v1: *OutputManagerV1) void {
                return @as(*server.wl.Resource, @ptrCast(_output_manager_v1)).destroy();
            }
            pub fn fromLink(_link: *server.wl.list.Link) *OutputManagerV1 {
                return @ptrCast(server.wl.Resource.fromLink(_link));
            }
            pub fn getLink(_output_manager_v1: *OutputManagerV1) *server.wl.list.Link {
                return @as(*server.wl.Resource, @ptrCast(_output_manager_v1)).getLink();
            }
            pub fn getClient(_output_manager_v1: *OutputManagerV1) *server.wl.Client {
                return @as(*server.wl.Resource, @ptrCast(_output_manager_v1)).getClient();
            }
            pub fn getId(_output_manager_v1: *OutputManagerV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_output_manager_v1)).getId();
            }
            pub fn getVersion(_output_manager_v1: *OutputManagerV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_output_manager_v1)).getVersion();
            }
            pub fn postNoMemory(_output_manager_v1: *OutputManagerV1) void {
                return @as(*server.wl.Resource, @ptrCast(_output_manager_v1)).postNoMemory();
            }
            pub fn getUserData(_output_manager_v1: *OutputManagerV1) ?*anyopaque {
                return @as(*server.wl.Resource, @ptrCast(_output_manager_v1)).getUserData();
            }
            pub const Request = union(enum) {
                destroy: void,
                get_xdg_output: struct {
                    id: u32,
                    output: *server.wl.Output,
                },
            };
            pub inline fn setHandler(
                _output_manager_v1: *OutputManagerV1,
                comptime T: type,
                handle_request: *const fn (_output_manager_v1: *OutputManagerV1, request: Request, data: T) void,
                comptime handle_destroy: ?fn (_output_manager_v1: *OutputManagerV1, data: T) void,
                _data: T,
            ) void {
                const _resource: *server.wl.Resource = @ptrCast(_output_manager_v1);
                _resource.setDispatcher(
                    common.Dispatcher(OutputManagerV1, T).dispatcher,
                    handle_request,
                    @ptrFromInt(@intFromPtr(_data)),
                    if (handle_destroy) |_handler| struct {
                        fn _wrapper(__resource: *server.wl.Resource) callconv(.C) void {
                            @call(.always_inline, _handler, .{
                                @as(*OutputManagerV1, @ptrCast(__resource)),
                                @as(T, @ptrCast(@alignCast(__resource.getUserData()))),
                            });
                        }
                    }._wrapper else null,
        ...
        pub const OutputV1 = opaque {
            pub const generated_version = 3;
            pub const interface = &common.zxdg.output_v1.interface;
            pub fn create(_client: *server.wl.Client, _version: u32, _id: u32) !*OutputV1 {
            ...
            pub fn fromLink(_link: *server.wl.list.Link) *OutputV1 {
                return @ptrCast(server.wl.Resource.fromLink(_link));
            }
            pub fn getLink(_output_v1: *OutputV1) *server.wl.list.Link {
                return @as(*server.wl.Resource, @ptrCast(_output_v1)).getLink();
            }
            pub fn getClient(_output_v1: *OutputV1) *server.wl.Client {
            ...
            pub fn postNoMemory(_output_v1: *OutputV1) void {
            ...
            pub fn sendLogicalPosition(_output_v1: *OutputV1, _x: i32, _y: i32) void {
                const _resource: *server.wl.Resource = @ptrCast(_output_v1);
                var _args = [_]common.Argument{
                    .{ .i = _x },
                    .{ .i = _y },
            ...
            pub fn sendLogicalSize(_output_v1: *OutputV1, _width: i32, _height: i32) void {
                const _resource: *server.wl.Resource = @ptrCast(_output_v1);
                var _args = [_]common.Argument{
                    .{ .i = _width },
                    .{ .i = _height },
            ...
            pub fn sendDone(_output_v1: *OutputV1) void {
                const _resource: *server.wl.Resource = @ptrCast(_output_v1);
                _resource.postEvent(2, null);
            }
            pub fn sendName(_output_v1: *OutputV1, _name: [*:0]const u8) void {
                const _resource: *server.wl.Resource = @ptrCast(_output_v1);
                var _args = [_]common.Argument{
                    .{ .s = _name },
                };
            ...
            pub fn sendDescription(_output_v1: *OutputV1, _description: [*:0]const u8) void {
                const _resource: *server.wl.Resource = @ptrCast(_output_v1);
                var _args = [_]common.Argument{
                    .{ .s = _description },
                };
    ...
    pub const zwp = struct {
        ...
        pub const TabletToolV2 = opaque {
            ...
            pub fn sendButton(_tablet_tool_v2: *TabletToolV2, _serial: u32, _button: u32, _state: ButtonState) void {
                const _resource: *server.wl.Resource = @ptrCast(_tablet_tool_v2);
                var _args = [_]common.Argument{
                    .{ .u = _serial }, .{ .u = _button }, .{ .u = switch (@typeInfo(ButtonState)) {
                        .@"enum" => @as(u32, @intCast(@intFromEnum(_state))),
                        .@"struct" => @bitCast(_state),
                        else => unreachable,
                    } },
        ...
        pub const TabletPadV2 = opaque {
            ...
            pub fn sendButton(_tablet_pad_v2: *TabletPadV2, _time: u32, _button: u32, _state: ButtonState) void {
                const _resource: *server.wl.Resource = @ptrCast(_tablet_pad_v2);
                var _args = [_]common.Argument{
                    .{ .u = _time }, .{ .u = _button }, .{ .u = switch (@typeInfo(ButtonState)) {
                        .@"enum" => @as(u32, @intCast(@intFromEnum(_state))),
                        .@"struct" => @bitCast(_state),
                        else => unreachable,
                    } },
    ...
    pub const zwlr = struct {
        ...
        pub const ScreencopyManagerV1 = opaque {
            pub const generated_version = 3;
            pub const interface = &common.zwlr.screencopy_manager_v1.interface;
            pub fn create(_client: *server.wl.Client, _version: u32, _id: u32) !*ScreencopyManagerV1 {
                return @ptrCast(try server.wl.Resource.create(_client, ScreencopyManagerV1, _version, _id));
            }
            pub fn destroy(_screencopy_manager_v1: *ScreencopyManagerV1) void {
                return @as(*server.wl.Resource, @ptrCast(_screencopy_manager_v1)).destroy();
            }
            pub fn fromLink(_link: *server.wl.list.Link) *ScreencopyManagerV1 {
                return @ptrCast(server.wl.Resource.fromLink(_link));
            }
            pub fn getLink(_screencopy_manager_v1: *ScreencopyManagerV1) *server.wl.list.Link {
                return @as(*server.wl.Resource, @ptrCast(_screencopy_manager_v1)).getLink();
            }
            pub fn getClient(_screencopy_manager_v1: *ScreencopyManagerV1) *server.wl.Client {
                return @as(*server.wl.Resource, @ptrCast(_screencopy_manager_v1)).getClient();
            }
            pub fn getId(_screencopy_manager_v1: *ScreencopyManagerV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_screencopy_manager_v1)).getId();
            }
            pub fn getVersion(_screencopy_manager_v1: *ScreencopyManagerV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_screencopy_manager_v1)).getVersion();
            }
            pub fn postNoMemory(_screencopy_manager_v1: *ScreencopyManagerV1) void {
                return @as(*server.wl.Resource, @ptrCast(_screencopy_manager_v1)).postNoMemory();
            }
            pub fn getUserData(_screencopy_manager_v1: *ScreencopyManagerV1) ?*anyopaque {
                return @as(*server.wl.Resource, @ptrCast(_screencopy_manager_v1)).getUserData();
            }
            pub const Request = union(enum) {
                capture_output: struct {
                    frame: u32,
                    overlay_cursor: i32,
                    output: *server.wl.Output,
                },
                capture_output_region: struct {
                    frame: u32,
                    overlay_cursor: i32,
                    output: *server.wl.Output,
                    x: i32,
            ...
            pub inline fn setHandler(
                _screencopy_manager_v1: *ScreencopyManagerV1,
                comptime T: type,
                handle_request: *const fn (_screencopy_manager_v1: *ScreencopyManagerV1, request: Request, data: T) void,
                comptime handle_destroy: ?fn (_screencopy_manager_v1: *ScreencopyManagerV1, data: T) void,
                _data: T,
            ) void {
                const _resource: *server.wl.Resource = @ptrCast(_screencopy_manager_v1);
                _resource.setDispatcher(
                    common.Dispatcher(ScreencopyManagerV1, T).dispatcher,
                    handle_request,
                    @ptrFromInt(@intFromPtr(_data)),
                    if (handle_destroy) |_handler| struct {
                        fn _wrapper(__resource: *server.wl.Resource) callconv(.C) void {
                            @call(.always_inline, _handler, .{
                                @as(*ScreencopyManagerV1, @ptrCast(__resource)),
                                @as(T, @ptrCast(@alignCast(__resource.getUserData()))),
                            });
                        }
                    }._wrapper else null,
        ...
        pub const ScreencopyFrameV1 = opaque {
            ...
            pub const Error = common.zwlr.screencopy_frame_v1.Error;
            pub const Flags = common.zwlr.screencopy_frame_v1.Flags;
            pub fn create(_client: *server.wl.Client, _version: u32, _id: u32) !*ScreencopyFrameV1 {
                return @ptrCast(try server.wl.Resource.create(_client, ScreencopyFrameV1, _version, _id));
            }
            pub fn destroy(_screencopy_frame_v1: *ScreencopyFrameV1) void {
                return @as(*server.wl.Resource, @ptrCast(_screencopy_frame_v1)).destroy();
            }
            pub fn fromLink(_link: *server.wl.list.Link) *ScreencopyFrameV1 {
                return @ptrCast(server.wl.Resource.fromLink(_link));
            }
            pub fn getLink(_screencopy_frame_v1: *ScreencopyFrameV1) *server.wl.list.Link {
                return @as(*server.wl.Resource, @ptrCast(_screencopy_frame_v1)).getLink();
            }
            pub fn getClient(_screencopy_frame_v1: *ScreencopyFrameV1) *server.wl.Client {
                return @as(*server.wl.Resource, @ptrCast(_screencopy_frame_v1)).getClient();
            }
            pub fn getId(_screencopy_frame_v1: *ScreencopyFrameV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_screencopy_frame_v1)).getId();
            }
            pub fn getVersion(_screencopy_frame_v1: *ScreencopyFrameV1) u32 {
                return @as(*server.wl.Resource, @ptrCast(_screencopy_frame_v1)).getVersion();
            }
            pub fn postNoMemory(_screencopy_frame_v1: *ScreencopyFrameV1) void {
                return @as(*server.wl.Resource, @ptrCast(_screencopy_frame_v1)).postNoMemory();
            }
            pub fn getUserData(_screencopy_frame_v1: *ScreencopyFrameV1) ?*anyopaque {
                return @as(*server.wl.Resource, @ptrCast(_screencopy_frame_v1)).getUserData();
            }
            pub fn postError(_screencopy_frame_v1: *ScreencopyFrameV1, _err: Error, _message: [*:0]const u8) void {
                return @as(*server.wl.Resource, @ptrCast(_screencopy_frame_v1)).postError(@intCast(@intFromEnum(_err)), _message);
            }
            pub const Request = union(enum) {
                copy: struct {
                    buffer: *server.wl.Buffer,
            ...
            pub inline fn setHandler(
                _screencopy_frame_v1: *ScreencopyFrameV1,
                comptime T: type,
                handle_request: *const fn (_screencopy_frame_v1: *ScreencopyFrameV1, request: Request, data: T) void,
                comptime handle_destroy: ?fn (_screencopy_frame_v1: *ScreencopyFrameV1, data: T) void,
                _data: T,
            ) void {
                const _resource: *server.wl.Resource = @ptrCast(_screencopy_frame_v1);
                _resource.setDispatcher(
                    common.Dispatcher(ScreencopyFrameV1, T).dispatcher,
                    handle_request,
                    @ptrFromInt(@intFromPtr(_data)),
                    if (handle_destroy) |_handler| struct {
                        fn _wrapper(__resource: *server.wl.Resource) callconv(.C) void {
                            @call(.always_inline, _handler, .{
                                @as(*ScreencopyFrameV1, @ptrCast(__resource)),
                                @as(T, @ptrCast(@alignCast(__resource.getUserData()))),
                            });
                        }
                    }._wrapper else null,
            ...
            pub fn sendBuffer(_screencopy_frame_v1: *ScreencopyFrameV1, _format: common.wl.shm.Format, _width: u32, _height: u32, _stride: u32) void {
                const _resource: *server.wl.Resource = @ptrCast(_screencopy_frame_v1);
                var _args = [_]common.Argument{
            ...
            pub fn sendFlags(_screencopy_frame_v1: *ScreencopyFrameV1, _flags: Flags) void {
                const _resource: *server.wl.Resource = @ptrCast(_screencopy_frame_v1);
                var _args = [_]common.Argument{
                    .{ .u = switch (@typeInfo(Flags)) {
                        .@"enum" => @as(u32, @intCast(@intFromEnum(_flags))),
                        .@"struct" => @bitCast(_flags),
                        else => unreachable,
                    } },
            ...
            pub fn sendReady(_screencopy_frame_v1: *ScreencopyFrameV1, _tv_sec_hi: u32, _tv_sec_lo: u32, _tv_nsec: u32) void {
                const _resource: *server.wl.Resource = @ptrCast(_screencopy_frame_v1);
                var _args = [_]common.Argument{
                    .{ .u = _tv_sec_hi },
                    .{ .u = _tv_sec_lo },
            ...
            pub fn sendFailed(_screencopy_frame_v1: *ScreencopyFrameV1) void {
                const _resource: *server.wl.Resource = @ptrCast(_screencopy_frame_v1);
                _resource.postEvent(3, null);
            }
            pub fn sendDamage(_screencopy_frame_v1: *ScreencopyFrameV1, _x: u32, _y: u32, _width: u32, _height: u32) void {
                const _resource: *server.wl.Resource = @ptrCast(_screencopy_frame_v1);
                var _args = [_]common.Argument{
                    .{ .u = _x },
                    .{ .u = _y },
            ...
            pub fn sendLinuxDmabuf(_screencopy_frame_v1: *ScreencopyFrameV1, _format: u32, _width: u32, _height: u32) void {
                const _resource: *server.wl.Resource = @ptrCast(_screencopy_frame_v1);
                var _args = [_]common.Argument{
                    .{ .u = _format },
                    .{ .u = _width },
            ...
            pub fn sendBufferDone(_screencopy_frame_v1: *ScreencopyFrameV1) void {
                const _resource: *server.wl.Resource = @ptrCast(_screencopy_frame_v1);
                _resource.postEvent(6, null);
            }
        };
    };
};
...
const common = struct {
    ...
    const zxdg = struct {
        ...
        const output_manager_v1 = struct {
            const interface: common.Interface = .{
                ...
                .methods = &.{
                    ...
                    .{
                        ...
                        .signature = "no",
                        .types = &.{
                            &common.zxdg.output_v1.interface,
                            &common.wl.output.interface,
                        },
                    },
                },
    ...
    const zwlr = struct {
        ...
        const screencopy_manager_v1 = struct {
            const interface: common.Interface = .{
                ...
                .methods = &.{
                    .{
                        ...
                        .signature = "nio",
                        .types = &.{
                            &common.zwlr.screencopy_frame_v1.interface,
                            null,
                            &common.wl.output.interface,
                        },
                    },
        ...
        const screencopy_frame_v1 = struct {
            const interface: common.Interface = .{
